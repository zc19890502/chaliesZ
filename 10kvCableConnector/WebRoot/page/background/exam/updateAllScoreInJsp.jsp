...
<script>
  function show(){ 
	...
	setTimeout("show()"); //设置过1000毫秒就是1秒，调用show方法 
     ...
     function checkScore(){
     var coldmidscore=$("#coldmidscore").val();
     var coldtemscore=$("#coldtemscore").val();
     var hotmidscore=$("#hotmidscore").val();
     var hottemscore=$("#hottemscore").val();
     var reg = /^([0-9_]{1,})([.]{0,1})([0-9_]{1,})+$/;
     var flag1=true,flag2=true,flag3=true,flag4=true;
     if(!(coldmidscore==null||coldmidscore=="")){
     	flag1 =reg.test(coldmidscore);
     }else{
        flag1=false;
     }
     if(!(coldtemscore==null||coldtemscore=="")){
     	flag2 =reg.test(coldtemscore);
     }else{
        flag2=false;
     }
     if(!(hotmidscore==null||hotmidscore=="")){
     	flag3 =reg.test(hotmidscore);
     }else{
        flag3=false;
     }
     if(!(hottemscore==null||hottemscore=="")){
     	flag4 =reg.test(hottemscore);
     }else{
        flag4=false;
     }  
	...
	<div class="container-fluid"
					...
					<div class="navbar-inner">
						<div class="container-fluid">
							...
							<div class="nav-collapse collapse navbar-responsive-collapse">
								<ul class="nav">
									<li><a href="page/background/admin-welcom.jsp"><i
								...
								<ul class="nav pull-right">
									...
									<li class="dropdown"><a data-toggle="dropdown"
										...
										<ul class="dropdown-menu">
											<li><a
												href="doqQueryManagerById.action?managerId=${ sessionScope.managerSession.managerId}">个人信息</a>
											</li>
		...
		<div class="row-fluid"
			...
			<div class="span9" style=" margin-top:20px;">
				<form action="doUpdateAllScoreById.action" method="post"
					...
					<div class="control-group" style=" margin-top:50px;">
						...
						<div class="controls">
							<input type="text" class="input-medium"
								value="${socreinfo.realName}" readonly="readonly"
								name="se.realName">
						</div>
					</div>
					<div class="controls">
						<input type="hidden" class="input-medium"
							value="${socreinfo.userInfoId}" name="se.userInfoId"> <input
							type="hidden" class="input-medium"
							value="${socreinfo.examInfoId}" name="se.examInfoId">
					</div>
					<div class="control-group">
						<label class="control-label" for="input01">准考证号</label>
						<div class="controls">
							<input type="text" class="input-medium"
								value="${socreinfo.number}" readonly="readonly" name="se.number">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-medium"
								value="${socreinfo.idnum}" readonly="readonly" name="se.idnum">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-medium"
								value="${socreinfo.place}" readonly="readonly" name="se.place">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-medium"
								value="${socreinfo.company}" readonly="readonly"
								name="se.company">
						</div>
					</div>

					<div class="control-group">
						<label class="control-label" for="input01">理论成绩</label>
						<div class="controls">
							<input type="text" class="input-medium" id="theoryscore"
								value="${socreinfo.theoryScore}" readonly="readonly"
								name="se.theoryScore">
						</div>
					</div>

					<div class="control-group">
						<label class="control-label" for="input01">冷缩(中)</label>
						<div class="controls">
							<input type="text" class="input-medium" id="coldmidscore"
								value="${socreinfo.coldMidScore}" name="se.coldMidScore">
						</div>
					</div>

					<div class="control-group">
						<label class="control-label" for="input01">冷缩(终)</label>
						<div class="controls">
							<input type="text" class="input-medium" id="coldtemscore"
								value="${socreinfo.coldTemScore}" name="se.coldTemScore">
						</div>
					</div>

					<div class="control-group">
						<label class="control-label" for="input01">热缩(中)</label>
						<div class="controls">
							<input type="text" class="input-medium" id="hotmidscore"
								value="${socreinfo.hotMidScore}" name="se.hotMidScore">
						</div>
					</div>

					<div class="control-group">
						<label class="control-label" for="input01">热缩(终)</label>
						<div class="controls">
							<input type="text" class="input-medium" id="hottemscore"
								value="${socreinfo.hotTemScore}" name="se.hotTemScore">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<button type="submit" class="btn-medium">提&nbsp;&nbsp;交</button>
						</div>
					</div>
				</form>
			</div>
