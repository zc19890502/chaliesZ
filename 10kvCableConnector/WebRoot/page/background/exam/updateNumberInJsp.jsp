	...
	<div class="container-fluid"
		...
		<div class="row-fluid"
			...
			<div class="span8" style=" margin-top:20px; margin-left: 100px;">
				<form action="doUpdateNumberById.action" method="post"
					class="form-horizontal"
					onsubmit="return numberSubmitCheck('numberInJsp')">
					<fieldset>
						<div id="legend" class="">
							<legend>修改准考证</legend>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input-medium"
								value="${socreinfo.number}" id="numberInJsp" name="se.number"
								onkeyup="checkNumber('numberInJsp')">
							<p class="help-inline" id="numbertip"></p>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
