...
<body onLoad="show()">
	...
	<div class="container-fluid"
		...
		<div class="row-fluid"
			...
			<div class="span9"
				style="height:500px; border-bottom:solid #0cF 1px; margin-top:10px; margin-left:50px;">
				<fieldset>
					<legend>批量上传考生准考证信息</legend>
				</fieldset>
				<div class="span12" style="margin-left:100px;margin-top:50px;">
					<!--  xls文件上传 -->
					<form action="doUpdateNumberXls.action" class="form-horizontal"
						...
						<div class="control-group">
							<div class="controls">
								<button type="submit" class="btn">更新准考证</button>
							</div>
						</div>
					</form>
				</div>
