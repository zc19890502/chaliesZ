	...
	<div class="container-fluid"
		...
		<div class="row-fluid"
			...
			<div class="span2" style="min-height: 600px;">
				<div class="accordion" id="accordion-49699" style="margin-top:30px;">
					...
					<div class="accordion-group">
						...
						<div id="accordion-element-292849" class="accordion-body collapse">
					...
					<div class="accordion-group">
						...
						<div id="accordion-element-292858"
			...
			<div class="span9"
				...
				<form class="form-inline" action="doQueryScoreByCondition.action"
					method="post">
					<fieldset>
						...
						<table style="margin-left:40px;border:1px; " cellpadding="10">
							<tr>
								...
								<td>批次:</td>
								<td><input type="text" class="input-small"
									placeholder="20141" id="place" name="c_scoreBatch"></td>

								<td>工作单位:</td>
								<td><input type="text" class="input-small"
									placeholder="工作单位" id="company" name="c_company"></td>
			...
			<div class="span8" style="margin-left:8%;">
				<form id="fom" name="fom">
						...
						<tbody>
							<tr>
								<s:splitPage pageSize="10"
									page="doQueryScoreByCondition.action?realName=${requestScope.realName }&company=${requestScope.company }&scoreBatch=${requestScope.scoreBatch }"
									data="${socreInfoList }">
									<tr>
                    ...
                    <td align="center">${splitData.examInfoId}</td>   --%>
										...
										<td align="center">${splitData.scoreBatch}</td>
							...
							<tr>
								<td colspan="10" style="text-align:right; border-bottom:none;">
									<button type="button" class="btn "
										onclick="javascript:location.href='doDownloadScoreXls.action?fileName=xls/down/yearscore.xls'">下载历年成绩</button>
								</td>
							</tr>
