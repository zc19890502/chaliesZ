...
function feePass(ordId){
	if(ordId==""||ordId==undefined){
		...
		if(confirm("确定缴费通过审核吗？")){
			document.getElementById("feeCheckForm").action="doCheckOperateFeePass.action?ordId="+ordId;
...
function feeFail(){
	...
	if(confirm("确定缴费没有通过审核吗？")){
		document.getElementById("feeCheckForm").action="doCheckOperateFeeFail.action"
		document.getElementById("feeCheckForm").submit();
		return true;
	}else 
		return false;	
                           ...
                           <fieldset  >
                              <div id="legend" class="">
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <img id="FeePhoto" src="${requestScope.examineeInfo.operateFeePath }" width="400" height="300"> 
                                    <p class="help-inline"></p>
                                  </div>
                                </div>
