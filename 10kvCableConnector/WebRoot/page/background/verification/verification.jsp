                	 ...
                	 <form form action="" method="post" class="form-horizontal" style="margin-left:30%;" method="post" action="doRegister.action">
                           <fieldset  >
                              <div id="legend" class="">
                                ...
                                <div class="control-group">
                                  <!-- Text input-->
                                  <label class="control-label" for="input01">邮寄通讯地址:</label>
                                  <div class="controls">
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                 <c:choose>
                                 	<c:when test="${requestScope.examineeInfo.checkState==0 or requestScope.examineeInfo.checkState==7}">
                                   	 	<input type="button" value="初审通过" class="btn btn-success "  onclick="javascript:if(confirm('确定要通过初审吗？')){var checkAdvice = document.getElementById('checkAdvice').value;location.href='doVerifyPass.action?examineeId=${requestScope.examineeInfo.examineeInfoId}&systemState=1&checkAdvice='+checkAdvice}"/>
                                 	...
                                 	<c:when test="${requestScope.examineeInfo.checkState==1 or requestScope.examineeInfo.checkState==2 or requestScope.examineeInfo.checkState==8}">
                                 		<input type="button" value="复审通过" class="btn btn-success "  onclick="javascript:if(confirm('确定要通过复审吗？')){var checkAdvice = document.getElementById('checkAdvice').value;location.href='doVerifyPass.action?examineeId=${requestScope.examineeInfo.examineeInfoId}&finalVerfyState=3&systemState=0&checkAdvice='+checkAdvice}"/>
                                	 ...
                                	 <button class="btn btn-success" onclick="javascript:location.href=history.back()">返回</button>
                                  </div>
                                </div>
                         </fieldset>
                    </form>
