                           ...
                           <fieldset  >
                              <div id="legend" class="">
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                   <input type="text" name="managerInfo.managerAccount" value="${requestScope.managerInfo.managerAccount }"><br>
                                  </div>
                                </div>
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <input type="text" name="managerInfo.realName" value="${requestScope.managerInfo.realName }"><br>
                                 ...
                                 <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <input type="text" name="managerInfo.passwd"><br>
                                    <p class="help-inline"></p>
                                  </div>
                                </div>
                                 <div class="control-group">
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <input type="text" name="managerInfo.email" value="${requestScope.managerInfo.email }"><br>
                                    <p class="help-inline"></p>
                                  </div>
                                </div>
                               
                               <c:if test="${managerInfo.powerGrade=='0' }">
	                               <div class="control-group">
	                                  <!-- Text input-->
	                                  <label class="control-label" for="input01">权限:</label>
	                                  <div class="controls">
	                                    <select name="managerInfo.powerGrade" id="managerPower">
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                  	<button type="submit" class="btn btn-success btn-large">确认修改</button>
