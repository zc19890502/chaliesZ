	...
	<div class="container-fluid"
		...
		<div class="row-fluid"
			...
			<div class="span9" style="margin-top:50px;">
				<form
					action="doUpdateManagerPsw.action?managerId=${ sessionScope.managerSession.managerId}"
					...
					<fieldset>
						...
						<div class="control-group">
							...
							<input type="hidden" name="managerId"
								value="${ sessionScope.managerSession.managerId}"> <label
								class="control-label" for="input01">旧密码：</label>
							<div class="controls">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="password" placeholder="请输再次入新密码" id="password"
									name="password"><br>
							</div>
						</div>
