	...
	<div class="container-fluid"
								...
								<ul class="nav pull-right">
									...
									<li class="dropdown"><a data-toggle="dropdown"
										...
										<ul class="dropdown-menu">
											<li><a
												href="doQueryAllManager.action?managerId=${ sessionScope.managerSession.managerId}">个人信息</a>
											</li>
		...
		<div class="row-fluid"
			...
			<div class="span9"
				...
				<form class="form-inline" action="doAddNotice.action" method="post">
					<fieldset>
						<legend>新增通知公告</legend>
					...
					<div>
						<script id="editor" name="myEditor" type="text/plain"
							style="width:800px;height:500px; margin-left:50px;"></script>
					</div>
