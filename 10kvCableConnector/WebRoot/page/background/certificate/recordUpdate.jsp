	...
	<div class="container-fluid"
		...
		<div class="row-fluid"
			...
			<div class="span9"
				...
				<fieldset>
					<legend>批量上传年度评价</legend>
				</fieldset>
				<div class="span12" style="margin-left:100px;margin-top:50px;">
					<!--  xls文件上传 -->
					<form action="doUpdateRecord.action" class="form-horizontal"
						enctype="multipart/form-data" method="post"
						onsubmit="return checkScoreFile()">
						...
						<div class="control-group">
							<div class="controls">
								<button type="submit" class="btn">更新年度评价</button>
							</div>
						</div>
					</form>
