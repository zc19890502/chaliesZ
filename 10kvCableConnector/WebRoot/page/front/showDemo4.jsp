  ...
  <body onLoad="show()">
	...
	<div class="row-fluid" style="background-color:#F0F0F0; margin-top: -20px;">
		...
		<script type="text/javascript">
			function backPage(){
				location="../10kvCableConnector/page/front/showDemo3.jsp";
			}
		</script>
        <div class="span10" >
			<div style="font-size: x-large;">操作向导:</div>
			<div>&nbsp;</div>
			<div style="font-size: large;">5、如果您上传理论考试缴费单扫描件通过审查,请点击<a href="doCheckResult.action">考试信息</a>查看考试时间</div>
			<div>&nbsp;</div>
			<div style="margin-left: 135px;padding-left: 135px;"><input type="button" value="上一步" onclick="backPage()" /></div>
		</div>
 	</div>
</div>
