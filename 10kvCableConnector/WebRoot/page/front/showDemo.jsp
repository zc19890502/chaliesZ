  ...
  <body onLoad="show()">
	...
	<div class="row-fluid" style="background-color:#F0F0F0; margin-top: -20px;">
		...
		<script type="text/javascript">
			function nextPage(){
				location="../10kvCableConnector/page/front/showDemo1.jsp";
			}
		</script>
        <div class="span10" >
			<div style="font-size: x-large;">操作向导:</div>
			<div>&nbsp;</div>
			<div style="font-size: large;">1、如果您还未报名，请点击<a href="gotoSignUp.action">报名入口</a>报名！</div>
			<div>&nbsp;&nbsp;&nbsp;&nbsp;<img src="../10kvCableConnector/images/1.png"></img><img src="../10kvCableConnector/images/2.png"></img></div>
			<div>&nbsp;</div>
			<div style="margin-left: 135px;padding-left: 135px;"><input type="button" value="下一步" onclick="nextPage()" /></div>
		</div>
 	</div>
</div>
