...
<html>
 ...
 <body>
    ...
    <div class="container-fluid whole">
		<div class="pull-left login">
					...
					<table width="100%" cellspacing="3" cellpadding="2"  style="margin-top:20px; font-size:14px; margin-left:5px;">
						...
						<tr>
								<c:choose>
  									...
  									<c:when test="${requestScope.err==2 }"><td colspan="2" align="center" style="color: red">验证码错误</td></c:when>
  								</c:choose>
						</tr>
						<tr>
							<td colspan="2" align="center">
							<button class="btn btn-success"  style="width:80px" type="submit">登陆</button>
							<p class="help-inline" ><a href="dogotoSendMail.action">忘记密码？</a>
							</td>
        	...
        	<div id="login">
				...
				<table width="200" align="center" cellpadding="5" height="130" style=" font-size: 18px;" >
					...
					<tr>
						<td style="text-align:left"><a href="gotoSignUp.action">报名入口</a></td>
               ...
               <div class="insert-block">
                        ...
                        <div class="insert">
                            <c:if test="${!empty userSession }">
                            <a href="javascript:alert('您不是管理员！');"><img src="images/admin-login.png" width="180" height="70"></a>
                            </c:if>
                            <c:if test="${empty userSession }">
                        ...
                        <div class="insert">
                            <a href="page/front/checkCertificate.jsp"><img src="images/check.png" width="180" height="70"></a>
                        </div>
              </div>
			  <div class="insert-block">
				<p>&nbsp;</p>
		...
		<div class=" pull-right" style="width:745px;" >
		  <div style="width:370px; height:700px; float:right;   border:1px solid #9ff;">
			<div class="heading">
				<div class=" row-fluid">
					<div class="span12"  style="background:url(images/head1.png) no-repeat;">
						<h4 style="margin-top:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;通知公告<p style="float:right; font-size:14px; font-style:italic;"><a href="doGetMoreNotice.action?noticeType=2">更多...</a></p></h4>
					</div>
				</div>
			</div>
			<table class="table table-hover ">
				<c:forEach items="${requestScope.noticeAnounceList}" var="notice">
					<tr>
						<td ><i class="icon-hand-right"></i></td>
						<td><a href="${notice.noticeContent }"  title="${notice.noticeHead }">${fn:substring(notice.noticeHead,"0","15") }...</a></td>
						<td><fmt:formatDate value="${notice.noticeDate }" type="date"/></td>
					</tr>
				</c:forEach>
			</table>
		  </div>	
		  <div style="width:370px; height:350px;  float:left;  border:1px solid #9ff; ">
			<div class="heading">
				<div class=" row-fluid">
					<div class="span12"  style="background:url(images/head1.png) no-repeat;">
						<h4 style="margin-top:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;行业动态<p style="float:right; font-size:14px; font-style:italic;"><a href="doGetMoreNotice.action?noticeType=1">更多...</a></p></h4>
					</div>
				</div>
			</div>
			<table class="table table-hover ">
				<c:forEach items="${requestScope.noticeNewList}" var="notice">
					<tr>
						<td ><i class="icon-hand-right"></i></td>
						<td><a href="${notice.noticeContent }" title="${notice.noticeHead }">
						${fn:substring(notice.noticeHead,"0","15") }...</a></td>
						<td><fmt:formatDate value="${notice.noticeDate }" type="date"/></td>
					</tr>
				</c:forEach>
			</table>
		  ...
		  <div style="width:370px; height:348px;  float:left;   border:1px solid #9ff;">
			<div class="heading">
				<div class=" row-fluid">
					<div class="span12"  style="background:url(images/head1.png) no-repeat;">
						<h4 style="margin-top:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;成绩公告<p style="float:right; font-size:14px; font-style:italic;"><a href="doGetMoreNotice.action?noticeType=3">更多...</a></p></h4>
					</div>
				</div>
			</div>
			<table class="table table-hover ">
				<c:forEach items="${requestScope.noticeExamList}" var="notice">
					<tr>
						<td ><i class="icon-hand-right"></i></td>
						<td><a href="${notice.noticeContent }" title="${notice.noticeHead }">${fn:substring(notice.noticeHead,"0","15") }...</a></td>
						<td><fmt:formatDate value="${notice.noticeDate }" type="date"/></td>
