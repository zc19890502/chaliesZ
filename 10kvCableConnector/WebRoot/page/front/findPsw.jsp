	...
	<div class="container-fluid whole ">
		...
		<div class="row-fluid" style="background-color:#F0F0F0; margin-top:-20px; min-height: 400px;">
			...
			<div class="span8">
				...
				<form  action="doSendEmail.action" name="form1" method="post" class="form-horizontal" style="margin-left:5%;">
					<fieldset  >
		                  <div id="legend">
		                    <legend>通过邮箱找回密码 </legend>
		                  </div>
		                  <br>
						  <div class="control-group">
		                      <!-- Text input-->
		                      <label class="control-label" for="input01">请输入您的身份证</label>
		                      <div class="controls">
		                       <input type="text" class="input-large" id="idnum" name="idnum"><br>
		                      </div>
		                    </div>
		                   
		                   <div class="control-group">
		                      <!-- Text input-->
		                      <label class="control-label" for="input01">您的接收邮箱</label>
		                      <div class="controls">
		                       <input type="text" class="input-large" id="email" name="email"><br>
		                      </div>
		                    </div>
		                    
		                    <div class="control-group">
		                      <div class="controls">
		                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-success ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发送邮件到指定邮箱 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
		                      </div>
		                    </div>
		               </fieldset>
				</form>
