...
public class doDownloadAllScoreXls {
    ...
    public InputStream getInputStream() {
         ...
         return ServletActionContext.getServletContext().getResourceAsStream("/xls/down/operator.xls");
    }
	...
	public String generateXls(){
		...
		try {
			gxl.getAllScoreXlsTable(url+"\\operator.xls");
